...
adb root
wait ${!}
adb shell pm enable org.blissroms.setupwizard || true
wait ${!}
adb shell pm enable org.blissroms.setupwizard/.SetupWizardActivity || true
wait ${!}
...
adb shell am start -c android.intent.category.HOME org.blissroms.setupwizard/.SetupWizardActivity
