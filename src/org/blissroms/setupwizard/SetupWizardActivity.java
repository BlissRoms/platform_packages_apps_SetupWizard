...
public class SetupWizardActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (SetupWizardUtils.isOwner()) {
            wizardBundle.putString(EXTRA_SCRIPT_URI, getString(R.string.bliss_wizard_script_uri));
        } else if (SetupWizardUtils.isManagedProfile(this)) {
            wizardBundle.putString(EXTRA_SCRIPT_URI,
                    getString(R.string.bliss_wizard_script_managed_profile_uri));
        } else {
            wizardBundle.putString(EXTRA_SCRIPT_URI,
                    getString(R.string.bliss_wizard_script_user_uri));
        }
